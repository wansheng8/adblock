# 📊 AdBlock 规则统计报告（含混合规则）

> 本报告由 GitHub Actions 自动生成，包含混合规则源

## 📈 总体统计

| 指标 | 数量 | 说明 |
|------|------|------|
| 黑名单规则 | 1183434 条 | 拦截广告和恶意内容的规则 |
| 白名单规则 | 21822 条 | 避免误拦截的例外规则 |
| 总规则数 | 1205256 条 | 所有规则总和 |
| 混合规则源 | 1 个 | 包含多个子规则源的混合源 |
| 生成时间 | 2026-01-06 19:00:40 | 北京时间 |
...
- **最后更新时间**: 2026-01-06 19:00:40 (北京时间)
- **更新频率**: 每8小时自动更新
- **下次更新时间**: 2026-01-07 03:00:40 (北京时间)
