...
| 指标 | 数量 | 说明 |
|------|------|------|
| 黑名单规则 | 900353 条 | 拦截广告和恶意内容的规则 |
| 白名单规则 | 20108 条 | 避免误拦截的例外规则 |
| 总规则数 | 920461 条 | 所有规则总和 |
| 混合规则源 | 1 个 | 包含多个子规则源的混合源 |
| 生成时间 | 2026-01-08 08:45:39 | 北京时间 |
...
- **最后更新时间**: 2026-01-08 08:45:39 (北京时间)
- **更新频率**: 每8小时自动更新
- **下次更新时间**: 2026-01-08 16:45:39 (北京时间)
