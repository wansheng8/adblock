...
> 本报告由 GitHub Actions 自动生成，包含高级规则分析和详细统计

## 📈 总体统计

| 指标 | 数量 | 说明 |
|------|------|------|
| 黑名单规则 | 2598138 条 | 拦截广告和恶意内容的规则 |
| 白名单规则 | 15875 条 | 避免误拦截的例外规则 |
| 总规则数 | 2614013 条 | 所有规则总和 |
| 高级规则 | 15738 条 | 包含高级语法的规则 |
| 混合规则源 | 1 个 | 包含多个子规则源的混合源 |
| 自定义规则 | 0 条 | 用户自定义的规则 |
| 生成时间 | 2026-01-08 14:40:16 | 北京时间 |
...
- `https://raw.githubusercontent.com/Kuroba-Sayuki/FuLing-AdRules/Master/OtherRules/TomatoNovelRules.txt`
...
- **最后更新时间**: 2026-01-08 14:40:16 (北京时间)
- **更新频率**: 每8小时自动更新
- **下次更新时间**: 2026-01-08 22:40:16 (北京时间)
- **数据来源**: 23+个主流广告规则源（含混合规则）
- **高级功能**: 支持15种规则类型，自动冲突检测，智能优化

## 📁 文件列表

| 文件名 | 描述 | 大小 |
|--------|------|------|
| blacklist.txt | 主广告拦截规则 | 71MB |
| whitelist.txt | 白名单例外规则 | 769KB |
| metadata.json | 规则元数据 | 574B |
| validation_report.json | 验证报告 | 7.0KB |
| advanced_statistics.md | 高级统计报告 | 36KB |
| statistics.md | 其他文件 | 35KB |
